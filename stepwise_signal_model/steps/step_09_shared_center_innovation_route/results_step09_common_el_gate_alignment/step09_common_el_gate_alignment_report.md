# Step09 Common-El Gate Alignment

This decision run uses only `cfg.backend_mode = 'step87_reference'` and tests three common-el gate modes. It does not use truth in route decisions.
...
- `gate_alignment_success_by_mode.png`
- `gate_alignment_false_high_by_mode.png`
- `gate_alignment_low_confidence_by_mode.png`
- `gate_alignment_route_distribution.png`
