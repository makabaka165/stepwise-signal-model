if isempty(getenv('STEP12_CHUNK_ID')) || isempty(getenv('STEP12_TOTAL_CHUNKS'))
    error('step12:ChunkWrapperMissingEnv', ...
        'Set STEP12_CHUNK_ID and STEP12_TOTAL_CHUNKS before run_step12_formal_chunk.');
end
...
if isempty(getenv('STEP12_RESUME_FROM_PARTIALS'))
    setenv('STEP12_RESUME_FROM_PARTIALS', '1');
end
if isempty(getenv('STEP12_SCORE_ENGINE'))
    setenv('STEP12_SCORE_ENGINE', 'loop_reference');
end
