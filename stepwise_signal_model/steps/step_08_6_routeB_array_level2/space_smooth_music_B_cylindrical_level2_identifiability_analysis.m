% Entry wrapper for the requested Step 08.6 level-2 identifiability script.
...
run(fullfile(script_dir, 'space_smooth_music_B_cylindrical_level2_ident_analysis.m'));
